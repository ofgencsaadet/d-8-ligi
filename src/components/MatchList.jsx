          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-600">
            {sortMatchesByDate(matches).map((match, index) => {
              ...
              return (
                <div key={index}>
                  {showDateSeparator && (
                    <div className="bg-gray-100 dark:bg-gray-700 border-t-2 border-blue-200 dark:border-blue-600 px-6 py-3">
                      <div className="text-center text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center justify-center space-x-2">
                        <span className="h-px bg-gray-300 dark:bg-gray-600 flex-1"></span>
                        <span className="px-3 bg-gray-100 dark:bg-gray-700">
                  ...
                  <div className="p-4 lg:p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4">
                      {/* Saat ve Hava Durumu */}
                      <div className="text-sm text-gray-500 dark:text-gray-400 lg:w-1/4">
                        ...
                        {type === 'upcoming' && isWithinWeek(match.date) && (() => {
                          ...
                          return weather ? (
                            <div className="mt-2 flex items-center space-x-1 text-xs">
                              ...
                              <span className="font-medium text-blue-600 dark:text-blue-400">{weather.temperature}°C</span>
                              <span 
                                className="text-gray-500 dark:text-gray-400 hidden sm:inline cursor-help" 
                      ...
                      <div className="flex items-center justify-center lg:w-1/2">
                        <div className="flex items-center space-x-3 text-base w-full">
                          <div className="text-right font-medium text-gray-800 dark:text-gray-200 flex-1 min-w-0">
                          ...
                          <div className="text-left font-medium text-gray-800 dark:text-gray-200 flex-1 min-w-0">
                      ...
                      <div className="text-center lg:w-1/4">
                        {type === 'upcoming' && (
                          <div className="flex flex-col space-y-2 items-center">
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 dark:bg-yellow-900/50 text-yellow-800 dark:text-yellow-200">
                              ⏳ Beklemede
                            </span>
                            {onTeamComparison && (
                              <button
                                onClick={() => onTeamComparison(match.team1, match.team2)}
                                className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-200 hover:bg-purple-200 dark:hover:bg-purple-900/70 transition-colors duration-200"
                              >
            ...
            <div key={groupName} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-600">
                {groupMatches.map((match, index) => (
                  <div key={index} className="p-4 lg:p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4">
